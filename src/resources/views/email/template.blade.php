...
<head>
  ...
  <style type="text/css">
    ...
    .foreground {
      background: {{ config('madmin-core.email.fg_color') }};
    }
  </style>
  @yield('style')
</head>
                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              @if(config('madmin-core.email.logo'))
                                <img height="auto" src="{{ $message->embed(config('madmin-core.email.logo')) }}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150">
                              @endif
                            </td>
                          </tr>
                        </tbody>
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:center;color:#93999f;">
                        © {{ date('Y') }} {{ config('madmin-core.email.footer_company') }}
                        <br>
                        E-mail: <a class="footer-link" href="mailto:{{ config('madmin-core.email.footer_email') }}">
                          {{ config('madmin-core.email.footer_email') }}
                        </a>
                        <br>
                        Web: <a class="footer-link" href="{{ config('madmin-core.email.footer_web') }}">
                          {{ config('madmin-core.email.footer_web') }}
                        </a>
                      </div>
                    </td>
                  </tr>
